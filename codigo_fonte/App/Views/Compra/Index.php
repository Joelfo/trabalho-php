        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="#" id="form-categoria" method="GET">
                    ...
                    <div class="form-group">
                        <label for="nome-produto">Fornecedor</label>
                        <input class="form-control" list="fornecedores" id="fornecedor-cnpj" name="fornecedor-cnpj">
                    ...
                    <div class="form-group">
                        <label for="nome-produto">Funcionario</label>
